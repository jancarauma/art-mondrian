...
SOURCES = graphics.c utils.c sound.c eastereggs/cobra/cobra.c problems.c problems/problem_0.c problems/problem_1.c problems/problem_2.c problems/problem_4.c main.c
OBJECTS = $(SOURCES:.c=.o)
TARGET = main.exe
